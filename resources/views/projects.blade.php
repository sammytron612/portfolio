...
<div class="mt-8">
    <a href="https://bnb.klw-design.co.uk" target="_blank" aria-label="Seaham Coastal Retreats" rel="nofollow" class="group block">
        <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 border border-zinc-700/50 hover:border-indigo-200/50 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-100/10 backdrop-blur-sm">
            ...
            <div class="relative p-6 lg:p-8">
                <div class="flex flex-col lg:flex-row lg:items-start gap-6">
                    <div class="flex-shrink-0 flex items-center justify-center min-h-[300px] lg:min-h-0 lg:block">
                    ...
                    <div class="flex-1 space-y-4">
                        <h3 class="text-2xl font-bold dark:text-white text-slate-800 group-hover:text-indigo-400 transition-colors duration-300">Seaham Coastal Retreats</h3>
                        <p class="dark:text-slate-300 text-slate-600 leading-relaxed">This project was developed at the request of a Client, with the direction of Showcasing rental airbnb style properties in Seaham County Durham. It includes an array of features including an admin section (managing refunds, bookings, reviews etc..), calendar blocking from an API, directly connecting to Booking.com and Airbnb plus online booking and payment via stripe and is fully SEO compliant</p>
...
<div class="w-full my-4 flex justify-center"><img class="h-32 md:min-w-48 md:hidden" src="{{ asset('storage/PowerShell.webp') }}" alt="PowerShell logo"></div>
