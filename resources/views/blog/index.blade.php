...
<div class="container mx-auto py-12 bg-white dark:bg-zinc-800">
    ...
    <p class="mb-4 text-lg text-gray-700 dark:text-gray-300">Welcome to the blog! Posts will appear here soon.</p>
    <main class="mb-4 text-lg text-gray-700 dark:text-gray-300">
        @if($blog)
            <div class="mb-8 p-6 rounded shadow bg-gray-50 dark:bg-zinc-900 mt-4">
                <h2 class="text-2xl font-bold mb-2 text-slate-800 dark:text-slate-100">{{ $blog->title ?? 'Untitled' }}</h2>
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-8 mt-4">
                @if($prevBlog)
                    <div class="mb-2 md:mb-0 text-center">
                        ...
                        <div class="my-2"><strong>{{ $prevBlog->title ?? 'Untitled' }}</strong></div>
                ...
                @if($nextBlog)
                    <div class="text-center">
                        ...
                        <div class="my-2"><strong>{{ $nextBlog->title ?? 'Untitled' }}</strong></div>
